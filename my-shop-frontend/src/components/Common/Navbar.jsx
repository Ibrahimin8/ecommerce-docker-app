            ...
            <div className="flex items-center gap-3 md:gap-4 border-l pl-4 border-gray-100">
              ...
              >
                ...
                <div className="hidden md:flex flex-col">
                  <span className="text-[9px] font-black uppercase text-gray-400 leading-none tracking-widest">Settings</span>
              ...
              {isAdmin && (
                <div className="flex items-center gap-1 bg-gray-50 p-1 rounded-xl border border-gray-100">
                  ...
                  <Link to="/admin/orders" className="p-2 text-gray-400 hover:text-red-600" title="Admin Order Management">
                    <List size={18} />
                  </Link>
                  <Link to="/admin" className="p-2 text-gray-400 hover:text-purple-600" title="Full Dashboard">
                    <Shield size={18} />
                  </Link>
                </div>
              )}
